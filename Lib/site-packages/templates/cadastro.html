<div>
    <form class="row g-3" style="margin-left: 30px;" action="/conectarBanco" method="POST">
        <div class="col-md-8">
        ...
        <div class="col-md-4">
          ...
          <input id="e_mail" name="email" type="text" class="form-control" placeholder="meu_email@gmail.com">
        </div>
